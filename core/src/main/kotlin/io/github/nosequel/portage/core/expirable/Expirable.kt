...
abstract class Expirable(val reason: String, val executor: UUID=PortageConstants.consoleUuid, val duration: Long=-1L, val start: Long=System.currentTimeMillis()) {
